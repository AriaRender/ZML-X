...
class _BotCommands:
    def __init__(self):
        ...
        self.RestartCommand     = [f'restart{CMD_SUFFIX}',   f'rst']
        ...
        self.UsersCommand       = f'usr'
        self.AuthorizeCommand   = f'au'
        self.UnAuthorizeCommand = f'un'
        self.AddSudoCommand     = f'asd'
        self.RmSudoCommand      = f'rmsd'
